...
enum { DASM_DISP = 233, DASM_IMM_S, DASM_IMM_B, DASM_IMM_W, DASM_IMM_D, DASM_IMM_WB, DASM_IMM_DB, DASM_VREG, DASM_SPACE, DASM_SETLABEL, DASM_REL_A, DASM_REL_LG, DASM_REL_PC, DASM_IMM_LG, DASM_IMM_PC, DASM_LABEL_LG, DASM_LABEL_PC, DASM_ALIGN, DASM_EXTERN, DASM_ESC, DASM_MARK, DASM_SECTION, DASM_STOP };
...
#define CK(x, st)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
    do {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        if (!(x)) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
            D->status = DASM_S_##st | (int)(p - D->actionlist - 1);                                                                                                                                                                                                                                                                                                                                                                                                                                                \
            return;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
        }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
    } while (0)
#define CKPL(kind, st)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
    do {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        if ((size_t)((char *)pl - (char *)D->kind##labels) >= D->kind##size) {                                                                                                                                                                                                                                                                                                                                                                                                                                     \
            D->status = DASM_S_RANGE_##st | (int)(p - D->actionlist - 1);                                                                                                                                                                                                                                                                                                                                                                                                                                          \
            return;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
        }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
    } while (0)
#else
    ...
    while (1) {
        ...
        if (action < DASM_DISP) {
            ...
            case DASM_SETLABEL:
                ...
                break; /* Neg. label ofs. */
            case DASM_VREG:
                CK((n & -16) == 0 && (n != 4 || (*p >> 5) != 2), RANGE_VREG);
                if (*p < 0x40 && p[1] == DASM_DISP)
                    mrm = n;
                if (*p < 0x20 && (n & 7) == 4)
                    ofs++;
                switch ((*p++ >> 3) & 3) {
...
#define dasmw(x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    do {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        *((unsigned short *)cp) = (unsigned short)(x);                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
        cp += 2;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    } while (0)
#define dasmd(x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    do {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        *((unsigned int *)cp) = (unsigned int)(x);                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        cp += 4;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    } while (0)
#else
#define dasmw(x)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
...
int dasm_checkstep(Dst_DECL, int secmatch)
{
    ...
    if (D->status == DASM_S_OK && secmatch >= 0 && D->section != &D->sections[secmatch])
