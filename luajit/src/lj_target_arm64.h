...
#define GPRDEF(_) _(X0) _(X1) _(X2) _(X3) _(X4) _(X5) _(X6) _(X7) _(X8) _(X9) _(X10) _(X11) _(X12) _(X13) _(X14) _(X15) _(X16) _(X17) _(X18) _(X19) _(X20) _(X21) _(X22) _(X23) _(X24) _(X25) _(X26) _(X27) _(X28) _(FP) _(LR) _(SP)
#define FPRDEF(_) _(D0) _(D1) _(D2) _(D3) _(D4) _(D5) _(D6) _(D7) _(D8) _(D9) _(D10) _(D11) _(D12) _(D13) _(D14) _(D15) _(D16) _(D17) _(D18) _(D19) _(D20) _(D21) _(D22) _(D23) _(D24) _(D25) _(D26) _(D27) _(D28) _(D29) _(D30) _(D31)
#define VRIDDEF(_)
...
#define RSET_FIXED (RID2RSET(RID_X18) | RID2RSET(RID_FP) | RID2RSET(RID_LR) | RID2RSET(RID_SP) | RID2RSET(RID_GL))
...
#define RSET_SCRATCH_FPR (RSET_RANGE(RID_D0, RID_D7 + 1) | RSET_RANGE(RID_D16, RID_D31 + 1))
...
{
    while (*p == (LJ_LE ? 0xd503201f : 0x1f2003d5))
        p++; /* Skip A64I_NOP. */
    return p + 3 + exitno;
}
/* Avoid dependence on lj_jit.h if only including lj_target.h. */
#define exitstub_trace_addr(T, exitno) exitstub_trace_addr_((MCode *)((char *)(T)->mcode + (T)->szmcode), (exitno))
...
typedef enum A64Shift { A64SH_LSL, A64SH_LSR, A64SH_ASR, A64SH_ROR } A64Shift;
...
/* ARM condition codes. */
typedef enum A64CC { CC_EQ, CC_NE, CC_CS, CC_CC, CC_MI, CC_PL, CC_VS, CC_VC, CC_HI, CC_LS, CC_GE, CC_LT, CC_GT, CC_LE, CC_AL, CC_HS = CC_CS, CC_LO = CC_CC } A64CC;
