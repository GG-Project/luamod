...
{
    void *p = VirtualAlloc((void *)hint, sz, MEM_RESERVE | MEM_COMMIT | MEM_TOP_DOWN, prot);
    if (!p && !hint)
...
static int mcode_setprot(void *p, size_t sz, int prot) { return mprotect(p, sz, prot); }
...
static void *mcode_alloc(jit_State *J, size_t sz)
{
    ...
    */
    ...
    uintptr_t target = ((uintptr_t)(void *)lj_vm_exit_handler & ~(uintptr_t)0x0fffffffu) + 0x08000000u;
#else
