...
double lj_vm_log2(double a) { return log(a) * 1.4426950408889634074; }
#endif

#ifdef LUAJIT_NO_EXP2
double lj_vm_exp2(double a) { return exp(a * 0.6931471805599453); }
#endif
...
#if LJ_HASFFI
int lj_vm_errno(void) { return errno; }
#endif
