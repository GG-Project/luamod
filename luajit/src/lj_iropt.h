...
#define lj_ir_set(J, ot, a, b) lj_ir_set_(J, (uint16_t)(ot), (IRRef1)(a), (IRRef1)(b))
...
#define lj_ir_ksimd(J, idx) lj_ir_ggfload(J, IRT_NUM, (uintptr_t)LJ_KSIMD(J, idx) - (uintptr_t)J2GG(J))
...
#endif
LJ_FUNC TRef lj_opt_narrow_arith(jit_State *J, TRef rb, TRef rc, TValue *vb, TValue *vc, IROp op);
