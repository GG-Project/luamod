...
#define GPRDEF(_) _(R0) _(SP) _(SYS1) _(R3) _(R4) _(R5) _(R6) _(R7) _(R8) _(R9) _(R10) _(R11) _(R12) _(SYS2) _(R14) _(R15) _(R16) _(R17) _(R18) _(R19) _(R20) _(R21) _(R22) _(R23) _(R24) _(R25) _(R26) _(R27) _(R28) _(R29) _(R30) _(R31)
...
#define RSET_FIXED (RID2RSET(RID_TMP) | RID2RSET(RID_SP) | RID2RSET(RID_SYS1) | RID2RSET(RID_SYS2) | RID2RSET(RID_JGL))
...
typedef enum PPCCC { CC_GE, CC_LE, CC_NE, CC_NS, CC_LT, CC_GT, CC_EQ, CC_SO } PPCCC;
