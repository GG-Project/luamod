...
#define IRFPMDEF(_)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    _(FLOOR)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
    _(CEIL) _(TRUNC) /* Must be first and in this order. */                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
        _(SQRT) _(EXP) _(EXP2) _(LOG) _(LOG2) _(LOG10) _(SIN) _(COS) _(TAN) _(OTHER)
...
*/
#define IRTDEF(_) _(NIL, 4) _(FALSE, 4) _(TRUE, 4) _(LIGHTUD, LJ_64 ? 8 : 4) _(STR, IRTSIZE_PGC) _(P32, 4) _(THREAD, IRTSIZE_PGC) _(PROTO, IRTSIZE_PGC) _(FUNC, IRTSIZE_PGC) _(P64, 8) _(CDATA, IRTSIZE_PGC) _(TAB, IRTSIZE_PGC) _(UDATA, IRTSIZE_PGC) _(FLOAT, 4) _(NUM, 8) _(I8, 1) _(U8, 1) _(I16, 2) _(U16, 2) _(INT, 4) _(U32, 4) _(I64, 8) _(U64, 8) _(SOFTFP, 4) /* There is room for 8 more types. */
...
#if LJ_GC64
#define IRT_IS64 ((1u << IRT_NUM) | (1u << IRT_I64) | (1u << IRT_U64) | (1u << IRT_P64) | (1u << IRT_LIGHTUD) | (1u << IRT_STR) | (1u << IRT_THREAD) | (1u << IRT_PROTO) | (1u << IRT_FUNC) | (1u << IRT_CDATA) | (1u << IRT_TAB) | (1u << IRT_UDATA))
#elif LJ_64
#define IRT_IS64 ((1u << IRT_NUM) | (1u << IRT_I64) | (1u << IRT_U64) | (1u << IRT_P64) | (1u << IRT_LIGHTUD))
#else
...
#define ir_k64(ir) check_exp((ir)->o == IR_KNUM || (ir)->o == IR_KINT64 || (LJ_GC64 && ((ir)->o == IR_KGC || (ir)->o == IR_KPTR || (ir)->o == IR_KKPTR)), &(ir)[1].tv)
#define ir_kptr(ir) check_exp((ir)->o == IR_KPTR || (ir)->o == IR_KKPTR, mref((ir)[LJ_GC64].ptr, void))

/* A store or any other op with a non-weak guard has a side-effect. */
static LJ_AINLINE int ir_sideeff(IRIns *ir) { return (((ir->t.irt | ~IRT_GUARD) & lj_ir_mode[ir->o]) >= IRM_S); }
