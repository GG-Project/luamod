...
enum { GCSpause, GCSpropagate, GCSatomic, GCSsweepstring, GCSsweep, GCSfinalize };
...
#define makewhite(g, x) ((x)->gch.marked = ((x)->gch.marked & (uint8_t)~LJ_GC_COLORS) | curwhite(g))
...
#define lj_gc_anybarriert(L, t)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (LJ_UNLIKELY(isblack(obj2gco(t))))                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
