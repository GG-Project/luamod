...
#define lj_meta_fastg(g, mt, mm) ((mt) == NULL ? NULL : ((mt)->nomm & (1u << (mm))) ? NULL : lj_meta_cache(mt, mm, mmname_str(g, mm)))
...
LJ_FUNCA TValue *lj_meta_arith(lua_State *L, TValue *ra, cTValue *rb, cTValue *rc, BCReg op);
