...
#define JIT_F_OPTSTRING "\4fold\3cse\3dce\3fwd\3dse\6narrow\4loop\3abc\4sink\4fuse"
...
#define JIT_F_OPT_3 (JIT_F_OPT_2 | JIT_F_OPT_FWD | JIT_F_OPT_DSE | JIT_F_OPT_ABC | JIT_F_OPT_SINK | JIT_F_OPT_FUSE)
...
#define SNAP_TR(slot, tr) (((SnapEntry)(slot) << 24) + ((tr) & (TREF_CONT | TREF_FRAME | TREF_REFMASK)))
#if !LJ_FR2
...
#define traceref(J, n) check_exp((n) > 0 && (MSize)(n) < J->sizetrace, (GCtrace *)gcref(J->trace[(n)]))
...
#define LJ_KSIMD(J, n) ((TValue *)(((intptr_t)&J->ksimd[2 * (n)] + 15) & ~(intptr_t)15))
