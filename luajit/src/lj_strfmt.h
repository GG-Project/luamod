...
/* Format types (max. 16). */
typedef enum FormatType { STRFMT_EOF, STRFMT_ERR, STRFMT_LIT, STRFMT_INT, STRFMT_UINT, STRFMT_NUM, STRFMT_STR, STRFMT_CHAR, STRFMT_PTR } FormatType;
...
LJ_FUNC const char *lj_strfmt_pushvf(lua_State *L, const char *fmt, va_list argp);
